...
A privacy-first email aliasing and forwarding service. Live at [mailflusher.com](https://mailflusher.com), hosted in Sweden.
...
- Servers are physically in Sweden (a single jurisdiction with strong constitutional privacy protections).
