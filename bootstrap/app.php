...
// Provide a fake request for console context so service providers that resolve 'request' don't crash
if ($app->runningInConsole() && ! $app->bound('request')) {
    $app->instance('request', Illuminate\Http\Request::create(env('APP_URL', 'https://localhost'), 'GET'));
}
