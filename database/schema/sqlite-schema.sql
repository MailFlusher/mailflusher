...
CREATE UNIQUE INDEX "alias_groups_user_id_name_unique" ON "alias_groups" ("user_id","name");
CREATE INDEX "alias_groups_user_id_sort_order_index" ON "alias_groups" ("user_id","sort_order");
...
CREATE UNIQUE INDEX "alias_leak_events_alias_id_sender_domain_unique" ON "alias_leak_events" ("alias_id","sender_domain");
CREATE INDEX "alias_leak_events_alias_id_status_index" ON "alias_leak_events" ("alias_id","status");
...
CREATE UNIQUE INDEX "alias_recipients_alias_id_recipient_id_unique" ON "alias_recipients" ("alias_id","recipient_id");
CREATE INDEX "alias_recipients_recipient_id_index" ON "alias_recipients" ("recipient_id");
...
CREATE UNIQUE INDEX "alias_sender_observations_alias_id_sender_domain_unique" ON "alias_sender_observations" ("alias_id","sender_domain");
CREATE INDEX "alias_sender_observations_alias_id_index" ON "alias_sender_observations" ("alias_id");
...
CREATE TABLE "aliases"(
  ...
  "attached_recipients_only" INTEGER NOT NULL DEFAULT 0,
  "expires_at" timestamp NULL DEFAULT NULL,
  "max_emails" INTEGER DEFAULT NULL,
  "on_expiry" VARCHAR(255) NOT NULL DEFAULT 'discard',
  ...
  PRIMARY KEY ("id"),
  FOREIGN KEY ("alias_group_id") REFERENCES "alias_groups" ("id")
);
CREATE UNIQUE INDEX "aliases_email_unique" ON "aliases" ("email");
CREATE INDEX "aliases_user_id_index" ON "aliases" ("user_id");
CREATE INDEX "aliases_aliasable_id_index" ON "aliases" ("aliasable_id");
CREATE INDEX "aliases_expires_active_idx" ON "aliases" ("expires_at","active");
CREATE INDEX "aliases_ghost_mode_index" ON "aliases" ("ghost_mode");
CREATE INDEX "aliases_alias_group_id_index" ON "aliases" ("alias_group_id");
...
CREATE UNIQUE INDEX "blocked_senders_user_id_type_value_unique" ON "blocked_senders" ("user_id","type","value");
CREATE INDEX "blocked_senders_value_index" ON "blocked_senders" ("value");
...
CREATE INDEX "domains_user_id_index" ON "domains" ("user_id");
...
CREATE UNIQUE INDEX "failed_deliveries_ir_dedupe_key_unique" ON "failed_deliveries" ("ir_dedupe_key");
CREATE INDEX "failed_deliveries_user_id_index" ON "failed_deliveries" ("user_id");
...
CREATE INDEX "outbound_messages_user_id_index" ON "outbound_messages" ("user_id");
...
CREATE TABLE "recipients"(
  ...
  "user_id" char(36) NOT NULL,
  "email" text NOT NULL,
  "can_reply_send" INTEGER NOT NULL DEFAULT 1,
  "should_encrypt" INTEGER NOT NULL DEFAULT 0,
  "inline_encryption" INTEGER NOT NULL DEFAULT 0,
  "protected_headers" INTEGER NOT NULL DEFAULT 0,
  "remove_pgp_keys" INTEGER NOT NULL DEFAULT 1,
  "remove_pgp_signatures" INTEGER NOT NULL DEFAULT 1,
...
CREATE INDEX "recipients_user_id_index" ON "recipients" ("user_id");
CREATE INDEX "recipients_user_pending_created_at_index" ON "recipients" ("user_id","pending","created_at");
...
CREATE INDEX "redirect_tokens_expires_at_index" ON "redirect_tokens" ("expires_at");
CREATE INDEX "redirect_tokens_alias_id_foreign" ON "redirect_tokens" ("alias_id");
...
CREATE INDEX "rules_user_id_index" ON "rules" ("user_id");
...
CREATE INDEX "stored_emails_alias_id_received_at_index" ON "stored_emails" ("alias_id","received_at");
...
CREATE UNIQUE INDEX "usernames_external_id_unique" ON "usernames" ("external_id");
CREATE INDEX "usernames_user_id_index" ON "usernames" ("user_id");
...
CREATE TABLE "users"(
  ...
  "strip_trackers" VARCHAR(255) NOT NULL DEFAULT 'off',
  "banner_location" varchar(255) NOT NULL DEFAULT 'top',
  "spam_warning_behaviour" varchar(255) NOT NULL DEFAULT 'banner',
  "list_unsubscribe_behaviour" INTEGER NOT NULL DEFAULT 0,
  "display_from_format" INTEGER NOT NULL DEFAULT 0,
  "login_redirect" INTEGER NOT NULL DEFAULT 0,
  ...
  "use_reply_to" INTEGER NOT NULL DEFAULT 0,
  "store_failed_deliveries" INTEGER NOT NULL DEFAULT 1,
  "save_alias_last_used" INTEGER NOT NULL DEFAULT 1,
  ...
  "vault_public_key" TEXT DEFAULT NULL,
  "vault_encrypted_private_key" TEXT DEFAULT NULL,
  "vault_created_at" timestamp NULL DEFAULT NULL,
  "ghost_lock_minutes" INTEGER NOT NULL DEFAULT 15,
  "ghost_preview_mode" VARCHAR(255) NOT NULL DEFAULT 'preview_10',
  "created_at" timestamp NULL DEFAULT NULL,
  "updated_at" timestamp NULL DEFAULT NULL,
  PRIMARY KEY ("id")
);
...
CREATE INDEX "webauthn_keys_user_id_foreign" ON "webauthn_keys" ("user_id");
...
CREATE INDEX "webhook_deliveries_status_next_retry_at_index" ON "webhook_deliveries" ("status","next_retry_at");
...
CREATE INDEX "webhooks_user_id_index" ON "webhooks" ("user_id");
