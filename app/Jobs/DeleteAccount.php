...
class DeleteAccount implements ShouldBeEncrypted, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $sharedDomainAliases = $this->user->aliases()->withTrashed()->whereIn('domain', config('mailflusher.all_domains'));
        ...
        $this->user->aliases()->withTrashed()->whereNotIn('domain', config('mailflusher.all_domains'))->forceDelete();
