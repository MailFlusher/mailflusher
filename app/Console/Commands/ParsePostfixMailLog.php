...
class ParsePostfixMailLog extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mailflusher:parse-postfix-mail-log';
    ...
    {
        $logPath = config('mailflusher.postfix_log_path', '/var/log/mail.log');
        ...
        $allDomains = config('mailflusher.all_domains', []);
