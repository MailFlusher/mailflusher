...
class ProxyAuthentication
{
    ...
    {
        $this->isProxyAuthenticationEnabled = config('mailflusher.use_proxy_authentication');
        $this->externalUserIdHeaderName = config('mailflusher.proxy_authentication_external_user_id_header');
        $this->usernameHeaderName = config('mailflusher.proxy_authentication_username_header');
        $this->emailHeaderName = config('mailflusher.proxy_authentication_email_header');
    }
