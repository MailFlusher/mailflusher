...
class SettingController extends Controller
{
    ...
    public function show()
    {
        return Inertia::render('Settings/General', [
            ...
            'stripTrackers' => user()->strip_trackers ?? 'off',
    ...
    public function webhooks()
    {
        return Inertia::render('Settings/Webhooks', [
            'initialWebhooks' => user()->canUseWebhooks()
                ? \App\Models\Webhook::where('user_id', user()->id)->orderByDesc('created_at')->get()
                : [],
        ]);
    }
    ...
    public function ghostInbox()
    {
        return Inertia::render('Settings/GhostInbox');
    }
