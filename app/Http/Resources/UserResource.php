...
class UserResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'username_limit' => config('mailflusher.additional_username_limit'),
            'alias_limit' => $this->planLimit('aliases'),
            'recipient_limit' => $this->planLimit('recipients'),
            'rule_limit' => $this->planLimit('rules'),
