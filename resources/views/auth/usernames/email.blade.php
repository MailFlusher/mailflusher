    ...
    <div class="p-6 bg-indigo-900 min-h-screen flex justify-center items-center">
        <div class="w-full max-w-md">
            <div class="flex justify-center text-white mb-6 text-5xl font-bold">
                <img class="w-48" alt="mailflusher.com Logo" src="/svg/logo.svg">
            </div>
                ...
                <form method="POST" action="{{ route('username.email') }}">
                    ...
                    <div class="px-6 py-8 md:p-10">
                        ...
                        <div class="mt-8 flex flex-wrap mb-6">
                            ...
                            <input id="email" type="text" class="appearance-none bg-grey-100 rounded w-full p-3 text-grey-700 focus:ring{{ $errors->has('email') ? ' border-red-500' : '' }}" name="email" value="{{ old('email') }}" placeholder="mrunknown@example.com" required>
