...
<body class="bg-white antialiased text-grey-900">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white border border-indigo-200 rounded-lg p-6">
                    ...
                    <ul class="text-sm text-grey-700 space-y-2 list-disc pl-5">
                        <li>You prefer hosting in Sweden over the Netherlands.</li>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-grey-100">
                        ...
                        <tr>
                            ...
                            <td class="text-center px-6 py-3">Netherlands (EU)</td>
                        </tr>
                        <tr>
    ...
    <section class="py-12 bg-grey-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4 text-grey-700">
                ...
                <p><strong class="text-grey-900">Mature self-host story.</strong> Addy.io publishes deployment docs and a self-host distribution, with a long-running community of self-hosters. {{ config('app.name', 'MailFlusher') }}'s source is also public (<a href="https://github.com/MailFlusher/mailflusher" rel="noopener" class="text-indigo-600 underline">AGPL-3.0 on GitHub</a>) but self-hosting isn't officially supported and we don't ship deployment docs.</p>
    ...
    <section class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4 text-grey-700">
                <p><strong class="text-grey-900">Sweden-based hosting.</strong> All servers in Sweden, run by us directly. Both services are EU/GDPR; the difference is which jurisdiction your data physically sits in (Sweden vs Netherlands). Pick the country whose regulatory regime you trust more.</p>
