<template>
  <div>
    ...
    <div class="sm:flex sm:items-center mb-6">
      ...
      <div v-if="enableCustomDomains" class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <button
          type="button"
      ...
      <template #table-row="props">
        ...
        <span v-else-if="props.column.field === 'catch_all'" class="flex items-center">
          <Toggle
            ...
            :disabled="!$page.props.user?.can_use_catch_all && !rows[props.row.originalIndex].catch_all"
          />
        </span>
      ...
      <p class="mt-1 text-md text-grey-500 dark:text-grey-200">
        {{
          enableCustomDomains
            ...
            : 'Custom domains are not enabled on this server.'
        }}
      </p>
      <div v-if="enableCustomDomains" class="mt-6">
        <button
          @click="openAddDomainModal"
          type="button"
          class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 text-sm font-medium shadow-sm focus:outline-none"
      ...
      <template v-if="!domainToCheck" v-slot:content>
        ...
        <div class="table w-full">
          ...
          <div class="table-row">
            ...
            <div class="table-cell py-2 dark:text-grey-100">
              <button
                @click="clipboard(`mf-verify=${aaVerify}`)"
        ...
        <div class="mt-6">
          ...
          <button
            ...
            class="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-4 rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        ...
        <div class="mt-2 text-sm dark:text-grey-200">
          ...
          <a
            href="https://mailflusher.com/help"
