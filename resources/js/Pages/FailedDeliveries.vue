<template>
  <div>
    ...
    <div class="sm:flex sm:items-center mb-6">
      ...
      <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <select
          v-model="filterType"
          @change="updateFilter"
          class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-grey-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md dark:border-grey-600 dark:bg-grey-700 dark:text-grey-200"
        >
    ...
    <Modal :open="moreInfoOpen" @close="moreInfoOpen = false">
      ...
      <template v-slot:content>
        <p class="mt-4 text-grey-700 dark:text-grey-200">
          Sometimes when mailflusher.com attempts to send an email, the delivery is not successful.
        ...
        <p class="mt-4 text-grey-700 dark:text-grey-200">
          ...
          mailflusher.com servers before reaching your alias.
        </p>
        <p class="mt-4 text-grey-700 dark:text-grey-200">
          Only failed delivery attempts from the mailflusher.com servers to your recipients (or
      ...
      <template v-slot:content>
        ...
        <div class="mt-6 flex flex-col space-y-3">
          <button
            ...
            class="w-full px-4 py-3 text-white font-semibold bg-indigo-600 hover:bg-indigo-500 border border-transparent rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed"
