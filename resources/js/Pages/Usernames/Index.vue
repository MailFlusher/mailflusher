<template>
  <div>
    ...
    <div class="sm:flex sm:items-center mb-6">
      ...
      <div v-if="rows.length < usernameLimit" class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <button
          type="button"
    ...
    <Modal :open="moreInfoOpen" @close="moreInfoOpen = false">
      ...
      <template v-slot:content>
        ...
        <p class="mt-4 text-grey-700 dark:text-grey-200">
          You can add a maximum of <b>{{ usernameLimit }}</b> usernames.
        </p>
