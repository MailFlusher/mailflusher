      ...
      <div class="space-y-8 divide-y divide-grey-200">
        ...
        <div class="pt-8">
          ...
          <p class="mt-1 text-base text-grey-700 dark:text-grey-200">
            ...
            Name' e.g. "example@{{ username.username }}.mailflusher.com".
          </p>
        ...
        <div class="pt-8">
          ...
          <p class="mt-2 text-base text-grey-700 dark:text-grey-200">
            ...
            <span class="bg-indigo-100 px-1 rounded-md dark:text-grey-900">^prefix</span>
          </p>
          <p class="mt-2 text-base text-grey-700 dark:text-grey-200">
            If you only want aliases that end with "suffix" to be automatically created, use the
            regex <span class="bg-indigo-100 px-1 rounded-md dark:text-grey-900">suffix$</span>
          </p>
          <p class="mt-2 text-base text-grey-700 dark:text-grey-200">
            If you want to make sure the local part is fully matched you can start your regex with
            <span class="bg-indigo-100 px-1 rounded-md dark:text-grey-900">^</span> and end it with
            <span class="bg-indigo-100 px-1 rounded-md dark:text-grey-900">$</span> e.g.
            <span class="bg-indigo-100 px-1 rounded-md dark:text-grey-900">^prefix.*suffix$</span>
              ...
              <div class="mt-2">
                <div class="flex">
                  ...
                  <span
                    ...
                    >@{{ username.username }}.mailflusher.com</span
                  >
                </div>
              </div>
              <p
