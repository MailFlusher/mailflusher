            ...
            <div class="w-full flex flex-wrap mt-8">
              ...
              >
                <button
                  ...
                  class="bg-indigo-600 w-full text-center hover:bg-indigo-500 text-white font-bold py-3 px-4 rounded focus:ring no-underline mx-auto disabled:cursor-not-allowed"
                >
