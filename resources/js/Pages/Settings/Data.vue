          ...
          >
            <div class="row">
              ...
              <div class="mt-4">
                <div
                  v-if="!domainsCount"
                  class="bg-indigo-600 block w-full text-center hover:bg-indigo-500 text-white font-bold py-3 px-4 rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-not-allowed"
                >
                ...
                <button
                  v-else
                  type="submit"
                  class="bg-indigo-600 block w-full text-center hover:bg-indigo-500 text-white font-bold py-3 px-4 rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Import Alias Data
                </button>
              </div>
