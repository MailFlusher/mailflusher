      ...
      <div class="pt-10">
        <div class="space-y-1">
          ...
          <p class="text-base text-grey-700 dark:text-grey-200">
            ...
            <a
              href="https://addons.mozilla.org/en-GB/firefox/addon/mailflusher/"
              target="_blank"
            ...
            to create new aliases. Simply paste
            a key you've created into the browser extension to get started. Your API
            access keys <b>are secret and should be treated like your password</b>.
          </p>
        </div>
        <div class="mt-4">
          <button
        ...
        <div v-show="accessToken">
          ...
          <div class="text-center">
            ...
            <p class="text-left text-sm mt-2 text-grey-700 dark:text-grey-200">
              You can scan this QR code to automatically login to the MailFlusher mobile app.
            </p>
          </div>
          <div class="mt-6">
            <button
