<template>
  <div>
    ...
    <div class="sm:flex sm:items-center mb-6">
      ...
      <div v-if="recipientLimit === 0 || rows.length < recipientLimit" class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <button
          type="button"
      ...
      <template #table-column="props">
        <span v-if="props.column.label == 'Key'">
          ...
          <span
            ...
            :data-tippy-content="`Use this to attach recipients to new aliases as they are created e.g. alias+key@${$page.props.user.username}.mailflusher.com. You can attach multiple recipients by doing alias+2.3.4@${$page.props.user.username}.mailflusher.com. Separating each key by a full stop.`"
          >
