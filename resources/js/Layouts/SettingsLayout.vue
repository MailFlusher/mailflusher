...
const allTabs = [
  ...
  },
  {
    ...
    current: route().current() === 'subscription.index',
    enabled: true,
  },
  {
    name: 'API Keys',
  ...
  },
  {
    ...
    current: route().current() === 'settings.webhooks',
    enabled: true,
  },
  {
    name: 'Import',
    href: route('settings.import'),
    current: route().current() === 'settings.import',
    enabled: true,
  },
  {
    name: 'Ghost Inbox',
    href: route('settings.ghost_inbox'),
    current: route().current() === 'settings.ghost_inbox',
    enabled: true,
  },
  {
    name: 'Account Data',
