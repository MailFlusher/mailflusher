<template>
  ...
  <svg v-else-if="name === 'trash'" xmlns="http://www.w3.org/2000/svg" viewBox="-3 -2 24 24">
    <path
  ...
  <svg v-else-if="name === 'delete'" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -5 24 24">
    <path
  ...
  <svg v-else-if="name === 'chevron-up'" xmlns="http://www.w3.org/2000/svg" viewBox="-5 -7.5 24 24">
    <path
      d="M7.071 2.828l-4.95 4.95A1 1 0 0 1 .707 6.364L6.364.707a1 1 0 0 1 1.414 0l5.657 5.657a1 1 0 0 1-1.414 1.414l-4.95-4.95z"
    ></path>
  </svg>

  <svg v-else-if="name === 'chevron-down'" xmlns="http://www.w3.org/2000/svg" viewBox="-5 -8 24 24">
    <path
  ...
  <svg v-else-if="name === 'edit'" xmlns="http://www.w3.org/2000/svg" viewBox="-2.5 -2.5 24 24">
    <path
  ...
  <svg v-else-if="name === 'envelope'" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -5 24 24">
    <path
  ...
  <svg v-else-if="name === 'search'" xmlns="http://www.w3.org/2000/svg" viewBox="-2.5 -2.5 24 24">
    <path
  ...
  <svg v-else-if="name === 'close-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24">
    <path
      d="M11.414 10l2.829 2.828a1 1 0 0 1-1.415 1.415L10 11.414l-2.828 2.829a1 1 0 1 1-1.415-1.415L8.586 10 5.757 7.172a1 1 0 0 1 1.415-1.415L10 8.586l2.828-2.829a1 1 0 0 1 1.415 1.415L11.414 10zM10 20C4.477 20 0 15.523 0 10S4.477 0 10 0s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16z"
    ></path>
  </svg>

  <svg v-else-if="name === 'plus'" xmlns="http://www.w3.org/2000/svg" viewBox="-4.5 -4.5 24 24">
    <path
      d="M8.9 6.9v-5a1 1 0 1 0-2 0v5h-5a1 1 0 1 0 0 2h5v5a1 1 0 1 0 2 0v-5h5a1 1 0 1 0 0-2h-5z"
    ></path>
  </svg>

  <svg v-else-if="name === 'save'" xmlns="http://www.w3.org/2000/svg" viewBox="-3 -3 24 24">
    <path
