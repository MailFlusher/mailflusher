<template>
  <Switch
    ...
    :disabled="disabled"
    :class="[
      modelValue ? 'bg-indigo-600' : 'bg-grey-300',
      disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer',
      'relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full transition-colors ease-in-out duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600',
    ]"
  >
