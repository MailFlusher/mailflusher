...
class SettingsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->user = $this->createUser('mrunknown', null, ['password' => Hash::make('mypassword')]);
    ...
    {
        $defaultAliasDomain = $this->user->username.'.flushed.com';
    ...
    public function user_can_update_reply_from_name()
    {
        ...
        $response->assertStatus(302);
        $this->assertEquals('Mr Unknown', $this->user->from_name);
    }
