...
class ProxyAuthenticationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Config::set('mailflusher.use_proxy_authentication', true);
        Config::set('mailflusher.proxy_authentication_external_user_id_header', 'X-User');
        Config::set('mailflusher.proxy_authentication_username_header', 'X-Name');
        Config::set('mailflusher.proxy_authentication_email_header', 'X-Email');
