...
class UserTest extends TestCase
{
    ...
    public function user_get_domain_options()
    {
        ...
        $expected = collect([
            'flushed.com',
            'mailflusher.com',
            $username.'.flushed.com',
            $username.'.mailflusher.com',
        ]);
    ...
    {
        $this->user->defaultRecipient->email = 'hello+mailflusher@example.com';
        $this->user->defaultRecipient->save();
        $this->assertTrue($this->user->isVerifiedRecipient('hello@example.com'));

        $this->user->defaultRecipient->email = 'hello+mailflusher+another@example.net';
        $this->user->defaultRecipient->save();
        $this->assertTrue($this->user->isVerifiedRecipient('hello@example.net'));

        $this->user->defaultRecipient->email = 'hello+mailflusher@example.net';
        $this->user->defaultRecipient->save();
        $this->assertTrue($this->user->isVerifiedRecipient('hello+mailflusher@example.net'));
    }
}
